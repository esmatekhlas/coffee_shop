          ...
          if($numRows== 1){
            echo "welcome";
                       session_start();
                        ...
                        header("location:/forum/index.php?user_name='.$user_name.'");
           }
          else {
          "not welcom";
    }
  ...
  <div class=" loginforum">
    <form action="'. $_SERVER['REQUEST_URI'].'" method="POST">
      <div class="formwhit" style="min-height=5000px;">
        ...
        <div class="signin">
          <a href="_signupModal.php">
              <button type="submit" class="btn btn-success">Rejester</button>
            </a>
      </div>
            </div>
